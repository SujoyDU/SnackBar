...
SECRET_KEY = 'xo6%5@-9lno3=4an+53#g&x4odqr52frqs358jbtrkn)#%6=n0'
...
DJOSER = {
    # 'DOMAIN': 'http://165.227.106.233',
    # 'SITE_NAME': 'Median',
    'PASSWORD_RESET_CONFIRM_URL': '#/password/reset/confirm/{uid}/{token}',
    'ACTIVATION_URL': '#/activate/{uid}/{token}',
    'SEND_ACTIVATION_EMAIL': False,
    'SERIALIZERS': {
        'user_registration': 'snackbar_app.serializers.UserProfileSerializer',
...
AUTH_USER_MODEL = 'snackbar_app.UserProfile'
